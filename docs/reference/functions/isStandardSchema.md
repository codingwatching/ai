...
Defined in: [packages/ai/src/activities/chat/tools/schema-converter.ts:72](https://github.com/TanStack/ai/blob/main/packages/ai/src/activities/chat/tools/schema-converter.ts#L72)
