/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1cb4a0b51823506e004334f12320a59d)
// Runtime types generated with workerd@1.20260617.1 2026-05-01 nodejs_compat
interface __BaseEnv_Env {
  ANTHROPIC_API_KEY: string
  RUN_COORDINATOR: DurableObjectNamespace<import('./src/server').RunCoordinator>
  Sandbox: DurableObjectNamespace<import('./src/server').Sandbox>
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import('./src/server')
    durableNamespaces: 'RunCoordinator' | 'Sandbox'
  }
